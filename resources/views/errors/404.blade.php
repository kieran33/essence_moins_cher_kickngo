    ...
    <div class="container">
        <div class="col-lg-6 mx-auto mb-4">
            <div class="error-content text-center">
                <img src="{{URL::to('assets/images/404-img.png')}}" alt="image-erreur" class="w-100">
                <h3 class="item_sec_title mt-4 mb-3">Oups! Page non trouvée.</h3>
                <p class="item_sec_desc">La page que vous recherchez n'est pas disponible !</p>
                <a href="{{URL::to('/')}}" class="primary_item_btn mt-3">Retour à l'accueil</a>
            </div>
        </div>
