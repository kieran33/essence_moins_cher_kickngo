    ...
    <div class="container">
        ...
        {!! Form::open(array('url' => array('submit_listing'),'class'=>'','name'=>'listing_form','id'=>'listing_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                     ...
                     @if(isset($listing->featured_image))
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                 ...
                                 <img src="{{ URL::asset('upload/entreprise/'.$listing->featured_image.'-s.jpg') }}" width="" alt="featured" class="category-img lazy">
                                </a>
                            </div>
                        </div>
                     @endif
            ...
            <div class="custom-control custom-checkbox mb-2">
                ...
                <label class="custom-control-label" for="termsCheckbox">{{trans('words.i_agree')}} <a href="{{ URL::to('conditions-generales/') }}" class="btn-link">{{getcong('terms_of_title')}}</a></label>
            </div>
            @endif 
